...
draft: false
summary: Learn how AI Skills in Microsoft Agent Framework solve context window limitations through progressive disclosure. This post explores why agent contexts become bloated with instructions and demonstrates how modular skills keep context lean while providing rich domain knowledge on demand.
---
